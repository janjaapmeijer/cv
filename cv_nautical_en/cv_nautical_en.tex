...
\cventry{2008 -- 2015}{Seaman at the deck department}{\textsc{Rederij Halfland} - shipping company}{Rotterdam, the Netherlands}{\footnotesize{\url{http://www.halfland.nl}}}{Assisting steersman and captain on two (\textsc{SV Rosa van Delft}) and three-masted (\textsc{SV Amazone}) sailing ships, and instructing the guests with setting the sails.}
...
\subsection{Teamwork}
\cvitem{}{I have worked effectively in small teams and larger collaborations with a combination of different disciplines, e.g. engineers, natural and social scientists, city planners and the local community. In a research setting, I play a bridging role between observationalists, modellers and theoreticians and I foster sharing knowledge with students or the broader public.}
...
\cvitemwithcomment{}{Long Range Operators Certificate of Proficiency (LROCP)}{}
\cvitemwithcomment{10 August 2023}{Car and motorcycle driving license}{category C and R}
